...
parser.add_argument("--gt_dir", help="path to folder containing images")
...
parser.add_argument("--scale_size", type=int, default=560, help="scale images to this size before cropping to 256x256")
...
def load_examples():
    ...
    with tf.name_scope("target_images"):
        ...
        targets_one_hot = tf.one_hot(targets, on_value = 1.0, off_value = -1.0, depth=NUM_OF_CLASSESS, axis=-1)
...
def load_examples2():
    ...
    if a.gt_dir is None or not os.path.exists(a.gt_dir):
        raise Exception("gt_dir does not exist")        
...
def create_model(inputs, targets, dropout):
    ...
    with tf.variable_scope("generator") as scope:
        ...
        outputs = create_generator(inputs, generator_outputs_channels=out_channels, dropout_rate=dropout)
